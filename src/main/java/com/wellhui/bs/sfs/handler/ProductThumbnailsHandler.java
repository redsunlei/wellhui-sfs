...
public class ProductThumbnailsHandler extends AbstractFileHandler {


    final static String  WEIBO_IMAGES_THUMBNAILS = Server.CONFIG.getProperty("product-thumbnails");
